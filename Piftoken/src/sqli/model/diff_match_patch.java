...
public class diff_match_patch {
  ...
  public static void main(String[] args){
	  for(Diff d : new diff_match_patch().diff_main("cab x", "cab x<q>"))
		  System.out.println(d);
	  for(Patch d : new diff_match_patch().patch_make("cab x", "cab x<q>"))
		  System.out.println(d);
  }
  
  public LinkedList<Diff> diff_lineMode(String text1, String text2) {
	  LinesToCharsResult a = this.diff_linesToChars(text1, text2);
