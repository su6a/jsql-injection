...
public class JTabbedPaneHeader extends JPanel implements ActionListener, MouseListener {
	private static final long serialVersionUID = 8127944685828300647L;
	
	private JTabbedPane valuesTabbedPane;
	
	public JTabbedPaneHeader(JTabbedPane newJTabbedPane){
		...
		JLabel tabTitleLabel = new JLabel(){
			...
			public String getText() {
                int i = valuesTabbedPane.indexOfTabComponent(JTabbedPaneHeader.this);
                if (i != -1) {
	...
	public void actionPerformed(ActionEvent e) {
		int closeTabNumber = valuesTabbedPane.indexOfTabComponent(JTabbedPaneHeader.this);
...
//	public void mouseClicked(MouseEvent e) {
//        Component component = e.getComponent();
//        if (component instanceof JTabbedPaneHeader) {
//			if(e.getButton() == MouseEvent.BUTTON2){
//				int closeTabNumber = valuesTabbedPane.indexOfTabComponent(this);
//				valuesTabbedPane.removeTabAt(closeTabNumber);
//				return;
//			} 
//        }
